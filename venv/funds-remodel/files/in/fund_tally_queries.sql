...
WITH
  ...
  INSERT INTO orders.fund_tally ( kristal_subscription_id, user_account_id, quantity, cost_nav, net_asset_value, dividends, eq_credit, eq_debit, transaction_fees, gain_or_loss, nav_calculation_time, created_time, updated_time, user_id, asset_id, custom_asset_id, return_percentage, fx_to_account, ib_leverage_in_account_currency, accrued_interest, kristal_id, no_of_subscribed_pending_units, amount_of_mf_order_pending, unit_cost_price, last_subscription_date, last_subscribed_by ) SELECT NULL, f.user_account_id, f.quantity, f.cost_nav, f.net_asset_value, coalesce(f.dividends,0), f.eq_credit, f.eq_debit, f.transaction_fees, f.gain_or_loss, f.nav_calculation_time, Now(), Now(), f.user_id, f.asset_id, f.custom_asset_id, f.return_percentage, f.fx_to_account, f.ib_leverage_in_account_currency, f.accrued_interest, ( SELECT kristal_id FROM kristaldata_kristals.kristal_properties WHERE kristal_composition::text ilike '%assetId: ' || f.asset_id || ',%'), 0,0, 0, NULL, 0 FROM funds_investo2o.fund f WHERE f.id = {} on conflict do nothing ;
  INSERT INTO orders.fund_tally ( kristal_subscription_id, user_account_id, quantity, cost_nav, net_asset_value, dividends, eq_credit, eq_debit, transaction_fees, gain_or_loss, nav_calculation_time, created_time, updated_time, user_id, asset_id, custom_asset_id, return_percentage, fx_to_account, ib_leverage_in_account_currency, accrued_interest, kristal_id, no_of_subscribed_pending_units, amount_of_mf_order_pending, unit_cost_price, last_subscription_date, last_subscribed_by ) SELECT s.kristal_subscription_id, s.kristal_execution_account, s.no_of_subscribed_approved_units, (s.unit_cost_price * s.no_of_subscribed_approved_units), (s.unit_cost_price * s.no_of_subscribed_approved_units), 0, 0, 0, 0, 0, null, Now(), Now(), s.user_id, (select coalesce(jsonb_path_query_first( kristal_composition, '$.constituentAssets[*] ? (@.assetClass == "FUND")."assetId"' )::bigint , lone_asset_id) from kristaldata_kristals.kristal_properties where kristal_id = s.kristal_id), null, 0, null, 0, 0, s.kristal_id, s.no_of_subscribed_pending_units, s.amount_of_mf_order_pending, coalesce(s.unit_cost_price,0), s.last_subscription_date, s.last_subscribed_by FROM funds_kristals.kristal_subscription s where s.kristal_subscription_id = {} on conflict do nothing ;
  INSERT INTO orders.fund_tally ( kristal_subscription_id, user_account_id, quantity, cost_nav, net_asset_value, dividends, eq_credit, eq_debit, transaction_fees, gain_or_loss, nav_calculation_time, created_time, updated_time, user_id, asset_id, custom_asset_id, return_percentage, fx_to_account, ib_leverage_in_account_currency, accrued_interest, kristal_id, no_of_subscribed_pending_units, amount_of_mf_order_pending, unit_cost_price, last_subscription_date, last_subscribed_by ) SELECT s.kristal_subscription_id, f.user_account_id, f.quantity, f.cost_nav, f.net_asset_value, coalesce(f.dividends,0), f.eq_credit, f.eq_debit, f.transaction_fees, f.gain_or_loss, f.nav_calculation_time, Now(), Now(), f.user_id, f.asset_id, f.custom_asset_id, f.return_percentage, f.fx_to_account, f.ib_leverage_in_account_currency, f.accrued_interest, s.kristal_id, s.no_of_subscribed_pending_units, s.amount_of_mf_order_pending, coalesce(s.unit_cost_price,0), s.last_subscription_date, s.last_subscribed_by FROM funds_investo2o.fund f , funds_kristals.kristal_subscription s WHERE s.kristal_subscription_id = {} and f.id = {} on conflict do nothing;